...
pub struct SoftwareFramebufferComponent<T>
where
    T: Copy + Clone,
{
    clear_data: T,
...
impl<T> Debug for SoftwareFramebufferComponent<T>
where
    T: Copy + Clone,
{
...
impl<T> SoftwareFramebufferComponent<T>
where
    T: Copy + Clone,
{
    pub fn new(clear_data: T) -> SoftwareFramebufferComponent<T> {
        SoftwareFramebufferComponent {
            clear_data,
...
impl<T> ComponentTrait for SoftwareFramebufferComponent<T> where T: Copy + Clone + 'static {}

impl<T> ComponentDebugTrait for SoftwareFramebufferComponent<T>
where
    T: Copy + Clone,
{
    fn get_name() -> String {
