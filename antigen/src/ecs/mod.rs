...
impl<'a> EntityComponentSystem<'a> {
    ...
    fn get_entity_by_predicate(&self, predicate: impl Fn(&EntityID) -> bool) -> Option<EntityID> {
        self.entity_component_directory.get_entity_by_predicate(predicate)
    }

    fn get_entities_by_predicate(&self, predicate: impl Fn(&EntityID) -> bool) -> Vec<EntityID> {
        self.entity_component_directory.get_entities_by_predicate(predicate)
    }
    ...
    fn get_components_by_predicate(
        ...
        self.entity_component_directory.get_components_by_predicate(predicate)
    }

    fn entity_has_component<T: ComponentTrait + 'static>(&self, entity_id: &EntityID) -> bool {
        self.entity_component_directory.entity_has_component::<T>(entity_id)
    }

    fn entity_has_component_by_id(&self, entity_id: &EntityID, component_id: &ComponentID) -> bool {
        self.entity_component_directory.entity_has_component_by_id(entity_id, component_id)
    }
    ...
    fn get_entity_component<T: ComponentTrait + 'static>(
        ...
        self.entity_component_directory.get_entity_component(entity_id)
    }
    ...
    fn get_entity_component_mut<T: ComponentTrait + 'static>(
        ...
        self.entity_component_directory.get_entity_component_mut(entity_id)
    ...
    fn get_entity_component_data_id(
        ...
        self.entity_component_directory.get_entity_component_data_id(entity_id, component_id)
    }
    ...
    fn add_component_to_entity<T: ComponentTrait + ComponentDebugTrait + 'static>(
        ...
        self.entity_component_directory.add_component_to_entity(entity_id, component_data)
    }
    ...
    fn remove_component_from_entity<T: ComponentTrait + ComponentDebugTrait + 'static>(
        ...
        self.entity_component_directory.remove_component_from_entity::<T>(entity_id)
    }
    ...
    fn register_system(&mut self, name: &str, system: &'a mut dyn SystemTrait<SingleThreadedDatabase<'a>>) {
