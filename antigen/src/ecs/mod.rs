...
use component::{get_component_id, ComponentData, ComponentID, ComponentInterface};
...
pub trait EntityComponentSystemDebug {
...
impl<'a> SingleThreadedECS {
    pub fn new() -> Self {
        SingleThreadedECS::default()
    }
}

impl<'a> Default for SingleThreadedECS {
    fn default() -> Self {
        SingleThreadedECS {
...
impl EntityComponentSystem for SingleThreadedECS {
    fn is_component_registered<T: ComponentTrait + 'static>(&self) -> bool {
...
impl EntityComponentSystemDebug for SingleThreadedECS {
    fn get_entity_label(&self, entity_id: EntityID) -> &str {
